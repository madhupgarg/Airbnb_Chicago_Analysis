...
# TEAM 5
# GROUP MEMBERS: ABHINAV SACHDEVA
#                HAMZA KHAN     
#                MADHUP GARG
#                SUMEET KUKREJA
#                SHALAKA COUTINHO
...
airbnbnum<- airbnb_test[,c(15,20,21,26,27)]
...
airbnb_avail<- airbnb_test[,c(17,18,19,20)]# Correlation Matrix of Availability
...
## Model3 (Dependant Variable: log(Price) after removing Outliers):
